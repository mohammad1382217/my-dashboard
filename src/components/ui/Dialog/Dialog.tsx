      ...
      >
        ...
        {showCloseButton ? (
          <button
            ...
            className="absolute inset-e-4 top-4 rounded-lg p-1 text-slate-400 outline-none transition-colors hover:bg-slate-100 hover:text-slate-700 focus-visible:ring-2 focus-visible:ring-indigo-500/40 dark:hover:bg-zinc-800 dark:hover:text-zinc-200"
          >
